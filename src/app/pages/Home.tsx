    ...
    <div className="min-h-screen" style={{ backgroundColor: '#E8EBEF' }}>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="mb-4" style={{ fontSize: '2.75rem', color: '#1D3C6E', fontWeight: '600', lineHeight: '1.2' }}>
            Never run out of<br />essentials again
          </h1>
          <p className="mb-6 text-lg" style={{ color: '#1D3C6E', opacity: '0.8' }}>
          ...
          <p className="mt-4 text-sm" style={{ color: '#1D3C6E', opacity: '0.6' }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="mb-3" style={{ fontSize: '1.125rem', color: '#1D3C6E', fontWeight: '600' }}>
                Choose products
              </h3>
              <p className="text-sm" style={{ color: '#1D3C6E', opacity: '0.7' }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="p-6 rounded-3xl bg-white text-center hover:scale-105 transition-transform cursor-pointer">
                <category.icon className="w-10 h-10 mx-auto mb-3" style={{ color: '#6FAEF2' }} />
                <p className="text-sm" style={{ color: '#1D3C6E', fontWeight: '500' }}>
                  {category.label}
                </p>
              </div>
            ))}
      ...
      <section id="pricing" className="py-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              { name: 'Bathroom pack', items: ['Toilet paper', 'Soap', 'Shampoo'] },
              { name: 'Kitchen pack', items: ['Paper towels', 'Dish soap', 'Sponges'] },
              { name: 'Cleaning pack', items: ['All-purpose', 'Glass cleaner', 'Wipes'] },
              { name: 'Custom pack', items: ['Choose your', 'own products'] },
            ].map((pack, idx) => (
              <div
                key={idx}
                className="p-5 rounded-3xl bg-white hover:shadow-xl transition-shadow"
                style={{ border: idx === 3 ? '2px solid #6FAEF2' : 'none' }}
              >
                <h3 className="mb-4" style={{ fontSize: '1.125rem', color: '#1D3C6E', fontWeight: '600' }}>
                  {pack.name}
                </h3>
                <ul className="space-y-2 mb-6">
                  {pack.items.map((item, i) => (
                    item && (
                      <li key={i} className="text-sm" style={{ color: '#1D3C6E', opacity: '0.7' }}>
                        • {item}
                      </li>
                    )
                  ))}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-10 rounded-3xl bg-white text-center">
            ...
            <p className="text-lg" style={{ color: '#1D3C6E', opacity: '0.7' }}>
              We learn your usage patterns and automate deliveries so you never have to think about it
            </p>
          </div>
        </div>
      </section>
