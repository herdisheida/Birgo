      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {!hasActiveSubscription ? (
          <div className="p-12 rounded-3xl bg-white text-center">
            <div className="w-20 h-20 rounded-full mx-auto mb-6 flex items-center justify-center" style={{ backgroundColor: '#E8EBEF' }}>
              <Package className="w-10 h-10" style={{ color: '#1D3C6E' }} />
            </div>
            <h2 className="mb-4" style={{ fontSize: '1.5rem', color: '#1D3C6E', fontWeight: '600' }}>
          ...
          <div className="grid gap-6">
            ...
            <div className="p-6 rounded-3xl bg-white">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#90C4F4' }}>
                    <Calendar className="w-6 h-6" style={{ color: '#1D3C6E' }} />
                  </div>
                  <div>
                    <h2 style={{ fontSize: '1.5rem', color: '#1D3C6E', fontWeight: '600' }}>
                      Active Subscription
                    </h2>
              ...
              {/* Next Delivery */}
              <div className="p-4 rounded-2xl mb-6" style={{ backgroundColor: '#90C4F4' }}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm mb-1" style={{ color: '#1D3C6E', opacity: '0.7' }}>
                      Next delivery
                    </p>
                    <p style={{ fontSize: '1.25rem', color: '#1D3C6E', fontWeight: '600' }}>
                      {getNextDeliveryDate()}
                    </p>
                  </div>
              ...
              {/* Actions */}
              <div className="mt-6 pt-6 border-t flex gap-3" style={{ borderColor: '#E8EBEF' }}>
                <button
                  onClick={() => navigate('/subscription')}
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-white text-center">
                <Calendar className="w-8 h-8 mx-auto mb-2" style={{ color: '#6FAEF2' }} />
                <p className="text-sm mb-1" style={{ color: '#1D3C6E', opacity: '0.7' }}>
                  Frequency
                </p>
                <p style={{ color: '#1D3C6E', fontWeight: '600' }}>
              ...
              <div className="p-4 rounded-2xl bg-white text-center">
                <Package className="w-8 h-8 mx-auto mb-2" style={{ color: '#6FAEF2' }} />
                <p className="text-sm mb-1" style={{ color: '#1D3C6E', opacity: '0.7' }}>
                  Products
                </p>
                <p style={{ color: '#1D3C6E', fontWeight: '600' }}>
